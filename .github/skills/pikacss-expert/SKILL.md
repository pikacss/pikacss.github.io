...
```ts
// pika() or pika.str() - Returns space-separated class names (default)
...
// pika.inl() - Inline interpolation (auto-generated by IDE)
const inline = `class="${pika({ color: 'red' })}"`
// Note: pika.inl is an IDE hover preview feature
```
...
- `prose-media` - Image/video/figure styles
- `prose-code` - Code/pre styles
- `prose-tables` - Table styles
- `prose` - Combines all above
...
4. **Style preview:** Hover over `pika()` function to see generated CSS

### Previewing Styles
Use `pika()` to enable hover preview of generated CSS (IDE feature):
...
- [Architecture](/docs/advanced/architecture.md) - Deep dive into PikaCSS internals
- [Real-World Examples](/docs/examples/components.md) - Practical usage patterns
- [Performance Optimization](/docs/advanced/performance.md) - Optimization techniques
- [Testing & Debugging](/docs/advanced/testing.md) - Testing strategies
- [SSR/SSG Guide](/docs/advanced/ssr.md) - Server-side rendering
- [Plugin Development](/docs/advanced/plugin-development.md) - Building custom plugins
