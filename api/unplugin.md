...
| `scan?` | `ScanOptions` | Glob patterns controlling which source files are scanned for `pika()` calls. | ``{ include: \['**/\*.{js,mjs,cjs,jsx,ts,mts,cts,tsx,vue}'], exclude: \['node\_modules/**', 'dist/**', '.git/**', '.nuxt/**', '.output/**', 'coverage/\*\*'] }``|
