...
<<< @/zh-TW/.examples/guide/built-ins/shortcuts-usage-string-arg.ts

<<< @/zh-TW/.examples/guide/built-ins/shortcuts-output-string-arg.css

**`__shortcut` 屬性** — 在 style definition object 中加入 `__shortcut` key，設定為一個 shortcut 名稱或名稱陣列。同一個物件中的其他屬性會套疊在 shortcut 之上。

<<< @/zh-TW/.examples/guide/built-ins/shortcuts-usage-property.ts

<<< @/zh-TW/.examples/guide/built-ins/shortcuts-output-property.css
